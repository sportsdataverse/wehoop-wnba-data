...
Mirrors ``R/wnba_11_team_crosswalk_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/wnba_11_team_crosswalk_creation.R``.

Equivalent to::

    python -m wnba_data_build --dataset team_crosswalk -s <start> -e <end>
"""
