...
Mirrors ``R/espn_wnba_04_rosters_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_wnba_04_rosters_creation.R``.

Equivalent to::

    python -m wnba_data_build --dataset rosters -s <start> -e <end>
"""
