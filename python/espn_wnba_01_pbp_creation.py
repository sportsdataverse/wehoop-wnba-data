...
Mirrors ``R/espn_wnba_01_pbp_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_wnba_01_pbp_creation.R``.

Equivalent to::

    python -m wnba_data_build --dataset pbp -s <start> -e <end>
"""
...
if __name__ == "__main__":
    ...
    # stage 01 build something other than pbp.
