...
Mirrors ``R/espn_wnba_07_standings_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_wnba_07_standings_creation.R``.

Equivalent to::

    python -m wnba_data_build --dataset standings -s <start> -e <end>
"""
...
if __name__ == "__main__":
    ...
    # stage 07 build something other than standings.
