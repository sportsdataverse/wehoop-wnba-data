...
Mirrors ``R/espn_wnba_03_player_box_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_wnba_03_player_box_creation.R``.

Equivalent to::

    python -m wnba_data_build --dataset player_box -s <start> -e <end>
"""
