...
Mirrors ``R/espn_wnba_02_team_box_creation.R`` -- same stage number, same dataset.
...
directory listing. It lines up with ``R/espn_wnba_02_team_box_creation.R``.

Equivalent to::

    python -m wnba_data_build --dataset team_box -s <start> -e <end>
"""
...
if __name__ == "__main__":
    ...
    # stage 02 build something other than team_box.
